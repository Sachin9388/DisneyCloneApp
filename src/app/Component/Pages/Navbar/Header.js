                ...
                >
                  ...
                  <defs>
                    <radialGradient
                      ...
                      gradientTransform="matrix(38.1794 0 0 39.4429 49.677 14.937)"
                    >
                      <stop offset=".01" stopColor="#fff" />
                      <stop offset=".04" stopColor="#C6FFFF" />
                      <stop offset=".09" stopColor="#80FFFF" />
                      <stop offset=".13" stopColor="#49FFFF" />
                      <stop offset=".17" stopColor="#21FFFF" />
                      <stop offset=".2" stopColor="#09FFFF" />
                      ...
                      <stop
                        ...
                        stopOpacity=".71"
                      />
                      <stop offset=".69" stopColor="#0E7FFF" stopOpacity=".5" />
                      <stop
                        offset=".87"
                        stopColor="#1639FF"
                        stopOpacity=".22"
                      />
                      <stop offset="1" stopColor="#1C00FF" stopOpacity="0" />
                    </radialGradient>
                  </defs>
                </svg>
                <button
